...
- `--verbose` prints ordered progress counters for each repository as the run happens, plus discovery mode, selected remotes, dry-run planning, restore steps, and dirty/local-only item paths.
